...
<div class="container">
    ...
    <div class="form-group">
      <?= form_label("Votre e-mail&nbsp;:", "email", ['class' => "col-md-4 control-label "]); ?>
    ...
    <div class="form-group">
      <?= form_label("Titre&nbsp;:", "title", ['class' => "col-md-4 control-label "]); ?>
    ...
    <div class="form-group">
      <?= form_label("Message&nbsp;:", "message", ['class' => "col-md-4 control-label "]); ?>
